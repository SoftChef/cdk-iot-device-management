...
const expectedRoles: {
  ...
  createThingFunctionS: 'ThingApiCreateThingFunctionServiceRoleF76C80DC',
  DeleteThingFunctionS: 'ThingApiDeleteThingFunctionServiceRoleECF4C781',
  DeleteThingShadowFun: 'ThingApiDeleteThingShadowFunctionServiceRole013D19BA',
  GetThingFunctionServ: 'ThingApiGetThingFunctionServiceRoleA6E745D2',
  GetThingShadowFuncti: 'ThingApiGetThingShadowFunctionServiceRole0EDFAE2B',
  ListThingShadowsFunc: 'ThingApiListThingShadowsFunctionServiceRoleAC9C364C',
  ListThingsFunctionSe: 'ThingApiListThingsFunctionServiceRoleF1D8A60D',
  UpdateThingFunctionS: 'ThingApiUpdateThingFunctionServiceRole428DBB63',
  UpdateThingShadowFun: 'ThingApiUpdateThingShadowFunctionServiceRoleC4BCE4CB',
};
...
test('minimal usage', () => {
  ...
  gApi(stack, ''ThingA: new 'ThingApi(stack, ''ThingApi');',

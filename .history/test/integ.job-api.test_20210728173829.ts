...
test('minimal usage', () => {
  ...
  expect(stack).toCountResources('AWS::ApiGateway::Resource', 18);
  expect(stack).toCountResources('AWS::ApiGateway::Method', 18);
  expect(stack).toCountResources('AWS::Lambda::Function', 18);
  expect(stack).toCountResources('AWS::IAM::Role', 18);
  expect(stack).toCountResources('AWS::IAM::Policy', 18);

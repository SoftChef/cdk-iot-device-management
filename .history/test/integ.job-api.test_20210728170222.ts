...
const expectedRoles: {
  ...
  cancelJobFunctionRole: '',
  cancelJobExecutionFunctionRole: 'JobApiCancelJobExecutionFunctionServiceRole7AB6614C',
  createJobFunctionRole: '',
  createJobTemplateFunctionRole: '',
  createScheduleJobFunctionRole: '',
  deleteJobFunctionRole: '',
  deleteJobExecutionFunctionRole: '',
  deleteJobTemplateFunctionRole: '',
  getJobFunctionRole: '',
  getJobDocumentFunctionRole: '',
  getJobExecutionFunctionRole: '',
  getJobTemplateFunctionRole: '',
  listJobExecutionsForJobFunctionRole: '',
  listJobExecutionsForThingFunctionRole: '',
  listJobTemplatesFunctionRole: '',
  listJobsFunctionRole: '',
  updateJobFunctionRole: '',
};

import { IoTClient, ListJobExecutionsForJobCommand, ListJobExecutionsForJobCommandInput } from '@aws-sdk/client-iot';
...
export async function handler(event: { [key: string]: any }) {
  ...
  try {
    ...
    let parameters: ListJobExecutionsForJobCommandInput = {

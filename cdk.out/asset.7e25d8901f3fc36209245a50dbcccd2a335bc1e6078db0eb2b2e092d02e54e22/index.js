...
// asset-input/src/lambda-assets/thing-groups/update-thing-group/app.ts
__export(exports, {
  handler: () => handler
});
...
async function handler(event) {
  ...
  try {
    ...
    const thingGroup = await iotClient.updateThingGroup({
      thingGroupName: request.parameter("thingGroupName"),
      thingGroupProperties: {
        thingGroupDescription: request.input("description", void 0)
      }
    }).promise();
